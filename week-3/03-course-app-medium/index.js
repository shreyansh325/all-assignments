...
async function writeArray(array, filepath){
...
let ADMINS = readArray(adminsFile);
let USERS = readArray(usersFile);
let COURSES = readArray(coursesFile);
let courseId = 0;
...
app.post('/admin/courses', authenticateAdmin, (req, res) => {
  ...
  if(!sameCourse){
    ...
    writeArray(COURSES, coursesFile);
